...
import { ENGINE_VARIANT_STORAGE_KEY, resolveVariantPreference } from '../engine/client';
...
export interface DiagnosticsLabels {
  ...
  unavailableMt: string; export: string; recent: string; load: string; slice: string; heap: string;
}
